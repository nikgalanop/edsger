...
let main =
   ...
   let s1 = newVariable (id_make "s1") TYPE_bool true in
   let s2 = newVariable (id_make "s2") TYPE_bool true in
   let s3 = newVariable (id_make "s3") TYPE_bool true in
   ...
   let p3 = newParameter (id_make "p3") TYPE_bool PASS_BY_REFERENCE p true in
   ...
   let t2 = newTemporary TYPE_bool in
   ignore t1; ignore t2;
   ...
   let y = newParameter (id_make "y") TYPE_bool PASS_BY_REFERENCE p true in
